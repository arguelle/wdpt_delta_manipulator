...
#ifndef DELTA_CONTROLLER_H_
#define DELTA_CONTROLLER_H_
...
{
 public:
  DeltaController(std::string usb_port, std::string baud_rate);
  ~DeltaController();
